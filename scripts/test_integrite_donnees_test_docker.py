...
if __name__ == "__main__":
    print("Début de l'exécution de test_integrite_donnees_test_docker.py")
    tester_integrite_donnees_test_docker()
    print("Fin de l'exécution de test_integrite_donnees_test_docker.py")
