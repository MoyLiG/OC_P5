...
def optimiser_collection_P5_test(mongo_uri="mongodb://localhost:27017/", db_name="P5_test", collection_name="dataset_donnees_medicales"):
    try:
...
if __name__ == "__main__":
    print("Début de l'exécution de local_optimiser_collection_P5_test.py")
    optimiser_collection_P5_test()
    print("Fin de l'exécution de local_optimiser_collection_P5_test.py")
