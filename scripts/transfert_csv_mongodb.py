...
def transfert_csv_mongodb(csv_file_path="/data/healthcare_dataset.csv", mongo_uri="mongodb://root:example@mongodb:27017/", db_name="P5", collection_name="dataset_donnees_medicales"):
    try:
