...
def optimiser_collection(mongo_uri="mongodb://localhost:27017/", db_name="P5", collection_name="dataset_donnees_medicales"):
    try:
...
if __name__ == "__main__":
    print("Début de l'exécution de local_optimiser_collection.py")
    optimiser_collection()
    print("Fin de l'exécution de local_optimiser_collection.py")
