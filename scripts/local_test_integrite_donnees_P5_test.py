...
def tester_integrite_donnees_P5_test(csv_file_path="data/healthcare_dataset.csv", mongo_uri="mongodb://localhost:27017/", db_name="P5_test", collection_name="dataset_donnees_medicales"):
    try:
...
if __name__ == "__main__":
    print("Début de l'exécution de local_test_integrite_donnees_P5_test.py")
    tester_integrite_donnees_P5_test()
    print("Fin de l'exécution de local_test_integrite_donneesP5_test.py")
